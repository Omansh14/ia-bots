...
export const AuditSidebar = ({ selectedItem = "Summary", onItemSelect }: AuditSidebarProps) => {
  // Category items
  const p2pItems = [
    "Validate Vendor KYC",
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-2">
          ...
          <button
            ...
            className={`w-full text-left px-3 py-2 text-sm rounded-md transition-colors mb-4 ${
