            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex gap-3">
                  <Button variant="outline" size="lg" className="gap-2 hover:cursor-pointer" onClick={() => navigate('/')}>
                    <ArrowLeft className="h-4 w-4" />
                    Return to Dashboard
                  </Button>
                  <Button size="lg" className="text-primary bg-primary/10 hover:bg-primary/20 hover:cursor-pointer">
                    Re-run
                  </Button>
                </div>
              </div>
